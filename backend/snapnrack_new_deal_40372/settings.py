"""
Django settings for snapnrack_new_deal_40372 project.
...
ROOT_URLCONF = 'snapnrack_new_deal_40372.urls'
...
WSGI_APPLICATION = 'snapnrack_new_deal_40372.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "snapnrack_new_deal_40372 API",
    "DESCRIPTION": "API documentation for snapnrack_new_deal_40372 App",
    "VERSION": "v1",
}
